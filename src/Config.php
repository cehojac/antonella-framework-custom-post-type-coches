...
class Config
{
    ...
    * @example ['post_data'=>'CPTC::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'CPTC::function']
    */
    public $get=[];
    /**
    ...
    * @input array
    * @example [['example','CPTC\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','CPTC\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
